...
enum SampleData {
  ...
  static var custodyRecords: [CustodyRecord] = [
    CustodyRecord(
      title: "Dock accessory exception custody",
      linkedEntityType: .inventoryReceipt,
      linkedEntityID: inventoryReceipts[0].id.uuidString,
      currentCustodianTeam: "Receiving Desk",
      previousCustodianTeam: "Carrier intake",
      custodyStatus: .disputed,
      custodyReason: "Damage exception held for evidence review.",
      handoffMethod: .storageMove,
      sourceLocationID: nil,
      destinationLocationID: storageLocations[0].id,
      ...
      evidenceAttachmentIDs: evidenceAttachments.prefix(1).map(\.id),
      assignedOwnerTeam: "Receiving Desk",
      transferDate: "Today 10:25 AM",
      expectedReturnCloseDate: "Today",
      notes: "Custody remains disputed until damage evidence and claim owner accept the exception.",
      riskLevel: .high,
      createdDate: "Today 10:25 AM",
      lastReviewedDate: "Never",
      reviewState: .needsReview
    ...
    CustodyRecord(
      title: "Label rolls stocked custody",
      linkedEntityType: .inventoryReceipt,
      linkedEntityID: inventoryReceipts[1].id.uuidString,
      currentCustodianTeam: "ParcelOps Operations",
      previousCustodianTeam: "Receiving Desk",
      custodyStatus: .received,
      custodyReason: "Stock moved to packing bench drawer A.",
      handoffMethod: .directHandoff,
      sourceLocationID: storageLocations[0].id,
      destinationLocationID: storageLocations[1].id,
      ...
      evidenceAttachmentIDs: [],
      assignedOwnerTeam: "ParcelOps Operations",
      transferDate: "Yesterday 3:30 PM",
      expectedReturnCloseDate: "Closed",
      notes: "Clean custody handoff accepted locally.",
      riskLevel: .low,
      createdDate: "Yesterday 3:30 PM",
      lastReviewedDate: "Yesterday 3:35 PM",
      reviewState: .accepted
    ...
    CustodyRecord(
      title: "Replacement staging custody missing",
      linkedEntityType: .storageLocation,
      linkedEntityID: storageLocations[2].id.uuidString,
      currentCustodianTeam: "Unassigned",
      previousCustodianTeam: "Unknown",
      custodyStatus: .needsReview,
      custodyReason: "Blocked replacement lacks confirmed source and destination custody.",
      handoffMethod: .manualUpdate,
      sourceLocationID: nil,
      ...
      evidenceAttachmentIDs: [],
      assignedOwnerTeam: "Receiving Desk",
      transferDate: "Not transferred",
      expectedReturnCloseDate: "Overdue",
      notes: "Missing custodian and location records must be corrected before local closure.",
      riskLevel: .critical,
      createdDate: "Today 11:05 AM",
      lastReviewedDate: "Never",
      reviewState: .needsReview
    )
  ]
